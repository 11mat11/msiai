 ...
 * </p>
 * <ul>
 *   <li>{@link projekt.impl.FormImpl#getBodyElements <em>Body Elements</em>}</li>
 *   <li>{@link projekt.impl.FormImpl#getText <em>Text</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FormImpl extends MinimalEObjectImpl.Container implements Form {
	...
	protected EClass eStaticClass() {
		return ProjektPackage.Literals.FORM;
	}
	...
	public EList<BodyElement> getBodyElements() {
		if (bodyElements == null) {
			bodyElements = new EObjectContainmentEList<BodyElement>(BodyElement.class, this,
					ProjektPackage.FORM__BODY_ELEMENTS);
		}
		return bodyElements;
	}
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProjektPackage.FORM__TEXT, oldText, text));
	}
