 ...
 * </p>
 * <ul>
 *   <li>{@link projekt.impl.FooterImpl#getBodyElements <em>Body Elements</em>}</li>
 *   <li>{@link projekt.impl.FooterImpl#getText <em>Text</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FooterImpl extends MinimalEObjectImpl.Container implements Footer {
	...
	protected EClass eStaticClass() {
		return ProjektPackage.Literals.FOOTER;
	}
	...
	public EList<BodyElement> getBodyElements() {
		if (bodyElements == null) {
			bodyElements = new EObjectContainmentEList<BodyElement>(BodyElement.class, this,
					ProjektPackage.FOOTER__BODY_ELEMENTS);
		}
		return bodyElements;
	}
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProjektPackage.FOOTER__TEXT, oldText, text));
	}
