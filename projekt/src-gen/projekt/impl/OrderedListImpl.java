 ...
 * </p>
 * <ul>
 *   <li>{@link projekt.impl.OrderedListImpl#getBodyElements <em>Body Elements</em>}</li>
 *   <li>{@link projekt.impl.OrderedListImpl#getText <em>Text</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OrderedListImpl extends MinimalEObjectImpl.Container implements OrderedList {
	...
	protected EClass eStaticClass() {
		return ProjektPackage.Literals.ORDERED_LIST;
	}
	...
	public EList<BodyElement> getBodyElements() {
		if (bodyElements == null) {
			bodyElements = new EObjectContainmentEList<BodyElement>(BodyElement.class, this,
					ProjektPackage.ORDERED_LIST__BODY_ELEMENTS);
		}
		return bodyElements;
	}
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProjektPackage.ORDERED_LIST__TEXT, oldText, text));
	}
