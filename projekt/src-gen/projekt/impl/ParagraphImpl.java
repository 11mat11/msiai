 ...
 * </p>
 * <ul>
 *   <li>{@link projekt.impl.ParagraphImpl#getBodyElements <em>Body Elements</em>}</li>
 *   <li>{@link projekt.impl.ParagraphImpl#getText <em>Text</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParagraphImpl extends MinimalEObjectImpl.Container implements Paragraph {
	...
	protected EClass eStaticClass() {
		return ProjektPackage.Literals.PARAGRAPH;
	}
	...
	public EList<BodyElement> getBodyElements() {
		if (bodyElements == null) {
			bodyElements = new EObjectContainmentEList<BodyElement>(BodyElement.class, this,
					ProjektPackage.PARAGRAPH__BODY_ELEMENTS);
		}
		return bodyElements;
	}
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProjektPackage.PARAGRAPH__TEXT, oldText, text));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case ProjektPackage.PARAGRAPH__BODY_ELEMENTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case ProjektPackage.PARAGRAPH__TEXT:
			return getText();
		}
