 ...
 * </p>
 * <ul>
 *   <li>{@link projekt.impl.TableCellImpl#getBodyElements <em>Body Elements</em>}</li>
 *   <li>{@link projekt.impl.TableCellImpl#getText <em>Text</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TableCellImpl extends MinimalEObjectImpl.Container implements TableCell {
	...
	protected EClass eStaticClass() {
		return ProjektPackage.Literals.TABLE_CELL;
	}
	...
	public EList<BodyElement> getBodyElements() {
		if (bodyElements == null) {
			bodyElements = new EObjectContainmentEList<BodyElement>(BodyElement.class, this,
					ProjektPackage.TABLE_CELL__BODY_ELEMENTS);
		}
		return bodyElements;
	}
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProjektPackage.TABLE_CELL__TEXT, oldText, text));
	}
