 ...
 * </p>
 * <ul>
 *   <li>{@link projekt.impl.UnorderedListImpl#getBodyElements <em>Body Elements</em>}</li>
 *   <li>{@link projekt.impl.UnorderedListImpl#getText <em>Text</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UnorderedListImpl extends MinimalEObjectImpl.Container implements UnorderedList {
	...
	protected EClass eStaticClass() {
		return ProjektPackage.Literals.UNORDERED_LIST;
	}
	...
	public EList<BodyElement> getBodyElements() {
		if (bodyElements == null) {
			bodyElements = new EObjectContainmentEList<BodyElement>(BodyElement.class, this,
					ProjektPackage.UNORDERED_LIST__BODY_ELEMENTS);
		}
		return bodyElements;
	}
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProjektPackage.UNORDERED_LIST__TEXT, oldText, text));
	}
