 ...
 * </p>
 * <ul>
 *   <li>{@link projekt.impl.SpanImpl#getBodyElements <em>Body Elements</em>}</li>
 *   <li>{@link projekt.impl.SpanImpl#getText <em>Text</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SpanImpl extends MinimalEObjectImpl.Container implements Span {
	...
	protected EClass eStaticClass() {
		return ProjektPackage.Literals.SPAN;
	}
	...
	public EList<BodyElement> getBodyElements() {
		if (bodyElements == null) {
			bodyElements = new EObjectContainmentEList<BodyElement>(BodyElement.class, this,
					ProjektPackage.SPAN__BODY_ELEMENTS);
		}
		return bodyElements;
	}
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProjektPackage.SPAN__TEXT, oldText, text));
	}
