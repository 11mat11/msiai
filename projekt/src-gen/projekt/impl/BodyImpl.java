 ...
 * </p>
 * <ul>
 *   <li>{@link projekt.impl.BodyImpl#getBodyElements <em>Body Elements</em>}</li>
 *   <li>{@link projekt.impl.BodyImpl#getText <em>Text</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BodyImpl extends MinimalEObjectImpl.Container implements Body {
	...
	protected EClass eStaticClass() {
		return ProjektPackage.Literals.BODY;
	}
	...
	public EList<BodyElement> getBodyElements() {
		if (bodyElements == null) {
			bodyElements = new EObjectContainmentEList<BodyElement>(BodyElement.class, this,
					ProjektPackage.BODY__BODY_ELEMENTS);
		}
		return bodyElements;
	}
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProjektPackage.BODY__TEXT, oldText, text));
	}
