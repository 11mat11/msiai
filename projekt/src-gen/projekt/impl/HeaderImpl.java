 ...
 * </p>
 * <ul>
 *   <li>{@link projekt.impl.HeaderImpl#getBodyElements <em>Body Elements</em>}</li>
 *   <li>{@link projekt.impl.HeaderImpl#getText <em>Text</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HeaderImpl extends MinimalEObjectImpl.Container implements Header {
	...
	protected EClass eStaticClass() {
		return ProjektPackage.Literals.HEADER;
	}
	...
	public EList<BodyElement> getBodyElements() {
		if (bodyElements == null) {
			bodyElements = new EObjectContainmentEList<BodyElement>(BodyElement.class, this,
					ProjektPackage.HEADER__BODY_ELEMENTS);
		}
		return bodyElements;
	}
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProjektPackage.HEADER__TEXT, oldText, text));
	}
