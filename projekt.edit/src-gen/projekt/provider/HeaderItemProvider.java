...
/**
 * This is the item provider adapter for a {@link projekt.Header} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HeaderItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addTextPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Header_text_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Header_text_feature", "_UI_Header_type"),
						ProjektPackage.Literals.HEADER__TEXT, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ProjektPackage.Literals.HEADER__BODY_ELEMENTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case ProjektPackage.HEADER__TEXT:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case ProjektPackage.HEADER__BODY_ELEMENTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(ProjektPackage.Literals.HEADER__BODY_ELEMENTS,
