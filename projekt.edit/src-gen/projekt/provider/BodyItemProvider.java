...
/**
 * This is the item provider adapter for a {@link projekt.Body} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BodyItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addTextPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Body_text_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Body_text_feature", "_UI_Body_type"),
						ProjektPackage.Literals.BODY__TEXT, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ProjektPackage.Literals.BODY__BODY_ELEMENTS);
		}
	...
	public String getText(Object object) {
		String label = ((Body) object).getText();
	...
	public void notifyChanged(Notification notification) {
		...
		case ProjektPackage.BODY__TEXT:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case ProjektPackage.BODY__BODY_ELEMENTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(ProjektPackage.Literals.BODY__BODY_ELEMENTS,
