...
/**
 * This is the item provider adapter for a {@link projekt.Form} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FormItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addTextPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Form_text_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Form_text_feature", "_UI_Form_type"),
						ProjektPackage.Literals.FORM__TEXT, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ProjektPackage.Literals.FORM__BODY_ELEMENTS);
		}
	...
	public String getText(Object object) {
		String label = ((Form) object).getText();
	...
	public void notifyChanged(Notification notification) {
		...
		case ProjektPackage.FORM__TEXT:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case ProjektPackage.FORM__BODY_ELEMENTS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(ProjektPackage.Literals.FORM__BODY_ELEMENTS,
